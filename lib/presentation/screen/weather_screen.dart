              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: data.hourlyTemp.length,
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final timeFormatted = DateFormat.j().format(
                        data.time[index],
                      );
                      return HourlyForecastItem(
                        time: timeFormatted,
                        temperature: '${data.hourlyTemp[index]} °C',
                        icon:
                            data.hourlySky[index] == 'Clouds' || data.hourlySky[index] == 'Rain'
                                ? Icons.cloud
                                : Icons.sunny,
                      );
                    },
